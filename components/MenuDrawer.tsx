...
export default function MenuDrawer({ isOpen, onClose, onNavigate, currentView }: MenuDrawerProps) {
  ...
  return (
    <>
      ...
      {/* Drawer Interface */}
      <aside className={`fixed top-0 left-0 h-full w-[85%] max-w-[380px] bg-[#050505] z-[70] transform transition-transform duration-500 ease-[cubic-bezier(0.2,1,0.3,1)] border-r border-white/5 flex flex-col shadow-[20px_0_80px_rgba(0,0,0,0.8)] ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
