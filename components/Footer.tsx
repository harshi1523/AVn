            ...
            <div className="flex gap-5">
              {[
                ...
                },
                {
                  ...
                  icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" viewBox="0 0 16 16">
                      <path d="M13.601 2.326A7.85 7.85 0 0 0 7.994 0C3.627 0 .068 3.559.064 7.926c0 1.399.366 2.76 1.06 3.978l-1.125 4.113 4.212-1.105a7.96 7.96 0 0 0 3.785.955h.005c4.366 0 7.923-3.559 7.927-7.93a7.95 7.95 0 0 0-2.325-5.614v-.001zM12.983 11.399c-.161.455-.785.811-1.085.864-.3.053-.591.074-.891.035-1.045-.125-2.004-.543-2.822-1.21-.137-.112-.271-.226-.398-.344l.001.001c-.131-.118-.255-.243-.374-.374l-.001-.001c-.118-.127-.232-.261-.344-.398-.667-.818-1.085-1.777-1.21-2.822a1.868 1.868 0 0 1 .035-.891c.053-.3.409-.924.864-1.085.3-.106.66-.106.96 0 .3.106.66.417.808.72l.43 1.03c.148.354.148.708 0 1.062l-.337.337c-.148.148-.148.354 0 .502.246.246.541.455.864.621.323.166.664.283 1.013.348l-.001-.001c.23.042.463-.042.639-.218l.337-.337c.354-.148.708-.148 1.062 0l1.03.43c.303.148.614.508.72.808.106.3.106.66 0 .96z" />
                    </svg>
                  )
                }
              ].map((social) => (
                <a
                  ...
                  className={`w-12 h-12 rounded-xl bg-white/5 flex items-center justify-center text-white ${social.color} hover:text-white transition-all duration-300 border border-white/10 hover:scale-110 shadow-lg hover:shadow-2xl`}
